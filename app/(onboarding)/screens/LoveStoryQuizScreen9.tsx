...
const LoveStoryQuizScreen9: React.FC<ScreenProps> = ({ formData, updateFormData, nextScreen, setCurrentScreen }) => {
  // चूंकि यह single-select है, हम केवल इसकी truthiness की जाँच करते हैं।
  const isNextEnabled: boolean = !!formData.milestoneCelebration;
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.progressBarContainer}>
          {/* Progress Bar: मान लीजिए कि यह 99% पर है */}
      ...
      <View style={styles.content}>
        ...
        {milestoneOptions.map((option: string) => (
          <TouchableOpacity
            key={option}
...
export default LoveStoryQuizScreen9;
...
const styles = StyleSheet.create({
  ...
  // Option Styles (Radio/Single-Select)
  radioOption: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: COLORS.lightGray,
