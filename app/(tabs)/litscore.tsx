...
const CouplesApp = () => {
  ...
  const WeeklyFeedbackScreen = () => (
    <View style={styles.screenContainer}>
      ...
      {/* Scrollable View for Weekly Feedback Screen */}
      <ScrollView style={styles.whiteBackground} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
